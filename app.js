...
$(document).ready(function ()
{
	...
	}, "Please re-enter a valid password, with at least one number and one letter, and over 5 characters");

	$.validator.addMethod("validFullName", function(value) {
		return hasOnlyLetters(value);
	}, "Please re-enter a valid name, with only letters.");
...
function handleNewUser(){
	...
	$('#form_registration_id').trigger("reset");
